...
Storm Call Shout Overhaul (SCSO) is a standalone Skyrim Special Edition / Anniversary Edition overhaul for the vanilla Storm Call shout. The current source release is **v2.1.1**.
